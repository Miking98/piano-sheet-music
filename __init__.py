...
#             e.transpose(value, inPlace=True)
    ...
    def findGaps(self, print____ = False):
        '''
        ...
        for offset, e in sortedElements:
            if offset > highestCurrentEndTime:
                gapElement = base.Music21Object()  # ElementWrapper(obj=None)
                gapQuarterLength = opFrac(offset - highestCurrentEndTime)
            ...
            if hasattr(e, 'duration') and e.duration is not None:
                ...
                eDur = 0.
            highestCurrentEndTime = opFrac(max(highestCurrentEndTime, offset + eDur))
